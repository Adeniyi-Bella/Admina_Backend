...
//       await expect(service.createChatHistory({})).rejects.toThrow('Valid chat history data is required');
//     });
...
//       await expect(service.createChatHistory({ userId, docId })).rejects.toThrow(
